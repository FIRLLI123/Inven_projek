...
public class Input_isi_saldo extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.input_isi_saldo);
...
//                startActivity(i);
        ...
        String kiriman4 = i.getStringExtra("namaitem");
        namaitem.setText(kiriman4);
        String kiriman5 = i.getStringExtra("qtysebelumnya");
        qtysebelumnya_rp.setText(formatrupiah(Double.valueOf(kiriman5)));
        String kiriman6 = i.getStringExtra("qtysebelumnya");
        qtysebelumnya.setText(kiriman6);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Input_isi_saldo.this, Isi_saldo.class);
    ...
    public void inputgak() {
        ...
        alertDialog = new AlertDialog.Builder(this)
                ...
                .setMessage("Silahkan Di cek Kembali ya \n" +
                        "Nama Item : "+namaitemalert+"\nAnda Menambahkan Stok Saldo sebanyak "+hargamodalalert)
                .setPositiveButton("OKE", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
...
//        int hasilstoksaatini_h = qtysebelumnya_h - qty_h;
    ...
    private void KasAdapter2(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "lap_migrasi_item.php" )
                //.addBodyParameter("nomor", nomor.getText().toString())
