...
public class Ada_gabung extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView i_namaitem, i_harga_t, i_hargamodal_t, i_qty_t, i_isi_t, i_nama_stok_t;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ada_gabung);
        ...
        i_harga_t = (TextView) findViewById(R.id.i_harga_t);
...
if(parameter.getText().toString().equals("fisik")){
    ...
    if (code.getText().toString().length() == 0) {                    //1
        ...
        String kiriman5 = i.getStringExtra("bidang");
        bidang_.setText(kiriman5);
    ...
    private final Runnable m_Runnable = new Runnable() {
        public void run() {
            ...
            Ada_gabung.this.mHandler.postDelayed(m_Runnable, 1000);
        }
    ...
    public void onBackPressed() {
        new AlertDialog.Builder(this)
                ...
                .setMessage("Kamu yakin ingin keluar? semua inputan saat ini akan di simpan di draft")
        ...
        if (requestCode == REQUEST_SELECT_BARANG) {
            if (resultCode == RESULT_OK) {
                if (data != null) {
                    ...
                    if(nama_beli.getText().toString().equals("Tarik Tunai")){
                        i_hargamodal_t.setText("Total Transfer");
                        i_harga_t.setText("Biaya Admin");
                        keterangan.setText("ISI STOK TARIK");


                    }else{
                        i_hargamodal_t.setText("Harga Modal");
                        i_harga_t.setText("Harga Jual");
                        keterangan.setText("PENJUALAN");
                    }
        ...
        AndroidNetworking.post(Config.host + "cekitem.php")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if(namaitem.getText().toString().equals("null")){
...
//        showDialog();
    ...
    public void inputdanjumlahkanaplikasi_elektrik(){
        ...
        String currentText = hargamodal.getText().toString();
        if (!currentText.isEmpty()) {
            // Hilangkan pemisah ribuan
            String cleanString = currentText.replaceAll("[^\\d]", "");
            hargamodal.setText(cleanString);
        }
        ...
        new CountDownTimer(1000, 1000) {
            ...
            public void onFinish() {
                ...
                if(namaitem.getText().toString().equals("Tarik Tunai")){
                    hideDialog();
                    inputgak_elektrik();
