...
public class Take_Out_Cash extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.take_out_cash);
...
//        showDialog();
        ...
        hitungHasil();
        int nilai1=Integer.valueOf(hargamodal_non_rp.getText().toString());
        int nilai2=Integer.valueOf(saldo2.getText().toString());
        //hitungstok();
        //int nilai1=Integer.valueOf(sisahstok1.getText().toString());
        new CountDownTimer(1000, 1000) {
            ...
            public void onFinish() {
                ...
                if(nilai2<nilai1){
                    Toast.makeText(getApplicationContext(), "Saldo Cash kurang", Toast.LENGTH_LONG).show();
                    hideDialog();
                }else{
                    hideDialog();
                    inputgak();
...
//        showDialog();
    ...
    public void inputgak() {
        ...
        String cashalert = saldo1.getText().toString();
        ...
        alertDialog = new AlertDialog.Builder(this)
                ...
                .setMessage("Silahkan Di cek Kembali ya \n" +
                        "Kamu akan mengambil : "+hargamodalalert+"\nStok Cash Menjadi : "+totalalert)
                .setPositiveButton("OKE", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (response.optString("response").toString().equals("success")) {
                            ...
                            Intent intent = new Intent(Take_Out_Cash.this, Mutasi_Cash.class);
