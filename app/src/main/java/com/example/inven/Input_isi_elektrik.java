...
public class Input_isi_elektrik extends AppCompatActivity {
    private ProgressDialog pDialog;
    private Context context;

    TextView iditem, nomor, nama_user, posisi, perusahaan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.input_isi_elektrik);
        ...
        context = Input_isi_elektrik.this;
...
//        });
        ...
        String kiriman4 = i.getStringExtra("nama_beli");
        namaitem.setText(kiriman4);
        String kiriman5 = i.getStringExtra("hargamodal");
        hargamodal.setText(kiriman5);
        String kiriman6 = i.getStringExtra("harga");
        hargajual.setText(kiriman6);
        String kiriman7 = i.getStringExtra("kategori");
        kategori.setText(kiriman7);

        String kiriman8 = i.getStringExtra("iditem");
        iditem.setText(kiriman8);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Input_isi_elektrik.this, Isi_elektrik.class);
    ...
    private void hapusitem() {
        ...
        AndroidNetworking.post(Config.host + "hapus_item_elektrik.php")
                .addBodyParameter("id", iditem.getText().toString())
...
//                .addBodyParameter("jam", jaminput1.getText().toString())
    ...
    private void save() {
        ...
        AndroidNetworking.post(Config.host + "input_item_elektrik.php")
                ...
                .addBodyParameter("harga", hargajual.getText().toString())
    ...
    private void update_harga() {
        ...
        AndroidNetworking.post(Config.host + "ubah_item_elektrik.php")
                .addBodyParameter("id", iditem.getText().toString())
