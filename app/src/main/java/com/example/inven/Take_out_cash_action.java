...
public class Take_out_cash_action extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.take_out_cash_action);
        ...
        context = Take_out_cash_action.this;
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (response.optString("response").toString().equals("success")) {
                            ...
                            Intent intent = new Intent(Take_out_cash_action.this, Mutasi_Cash.class);
