...
public class Input_item_saldo extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.input_item_saldo);
...
//                    tvNumber.setText(num);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Input_item_saldo.this, Isi_saldo.class);
    ...
    public void inputgak() {
        ...
        alertDialog = new AlertDialog.Builder(this)
                ...
                .setMessage("Silahkan Di cek Kembali ya \n" +
                        "Nama Item : "+namaitemalert+"\nDengan Stok Saldo : "+hargamodalalert)
                .setPositiveButton("OKE", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
