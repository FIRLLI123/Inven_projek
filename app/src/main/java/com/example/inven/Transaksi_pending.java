...
public class Transaksi_pending extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.transaksi_pending);
        ...
        context = Transaksi_pending.this;
        ...
        bidang = (TextView) findViewById(R.id.bidang);//1
...
//        day = c.get(Calendar.DATE);
    ...
    private void KasAdapter3(){
        ...
        //Log.d("link", LINK );
        AndroidNetworking.post( Config.host + "tampil_pending.php" )
...
//                                map.put("pembayaran",       responses.optString("pembayaran"));
    ...
    private void Adapter2(){
        ...
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, aruskas, R.layout.list_data_pending,
        ...
        listinputperdana1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                hapuss.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        showDeleteConfirmationDialog(idDataTextView.getText().toString(),tglDataTextView.getText().toString());
                    }
                });
                ...
                String g = bidang.getText().toString();

                Intent i = new Intent(getApplicationContext(), Ada_gabung_lanjut.class);
                i.putExtra("nomor",""+a+"");
    ...
    private void showDeleteConfirmationDialog(final String idData, final String tanggalData) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage("Apakah Anda yakin ingin menghapus data?")
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        // User chooses Yes, then delete data
                        deleteData(idData, tanggalData);
                    }
                })
                .setNegativeButton("Tidak", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        // User chooses No, close the dialog
                        dialog.dismiss();
                    }
                });
    ...
    private void deleteData(String idData, String tanggalData) {
        AndroidNetworking.post(Config.host + "hapus_pending.php")
                .addBodyParameter("nomor", idData)
                .addBodyParameter("tanggal", tanggalData)
                .addBodyParameter("perusahaan", perusahaan.getText().toString())
                .setPriority(Priority.MEDIUM)
                .build()
                .getAsJSONObject(new JSONObjectRequestListener() {
                    @Override
                    public void onResponse(JSONObject response) {
                        // Handle response after deleting data
                        if (response.optString("response").equals("success")) {
                            ...
                            KasAdapter3();
                            // ... (Do whatever needs to be done after deletion)
                        } else {
                    ...
                    @Override
                    public void onError(ANError error) {
                        // Handle error if there's an issue while deleting data
                    }
                });
    }
