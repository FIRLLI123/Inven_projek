...
public class Pembayaran_akhir_ulang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pembayaran_akhir_ulang);
        ...
        context = Pembayaran_akhir_ulang.this;
    ...
    public void proses_dikit(){
        ...
        new CountDownTimer(1000, 1000) {
            ...
            public void onFinish() {
                ...
                String d = uang_list.getText().toString();
                String e = kembalian_list.getText().toString();
                ...
                Intent x = new Intent(getApplicationContext(), Cetak_input_fisik.class);
                x.putExtra("tanggal", "" + a + "");
                x.putExtra("nomor", "" + b + "");
                x.putExtra("nama_pelanggan", "" + c + "");
                x.putExtra("rp_uang", "" + d + "");
                x.putExtra("rp_kembalian", "" + e + "");
                x.putExtra("nama_user", "" + f + "");
                x.putExtra("posisi", "" + g + "");
                x.putExtra("perusahaan", "" + h + "");
                x.putExtra("username", "" + j + "");
